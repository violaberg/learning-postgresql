...
# artists = session.query(Artist).filter_by(ArtistId).first()
# print(artist.ArtistId, artist.Name, sep=" | ")

# Query 5 - select only the albums "ArtistId" #51 from the "Album" table
# artists = session.query(Artist).filter_by(ArtistId=51)
# for album in albums:
